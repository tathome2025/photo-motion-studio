...
export const STUDIO_TEMPLATE_PRESETS: StudioTemplatePreset[] = [
  {
    key: "clean-cut",
    label: "Aurora Flow",
    description: "Soft aurora background with clean centered storytelling.",
    backgroundVideoPath: "/background-themes/theme-01.mp4",
    transitionKey: "cut",
    themeKey: "editorial",
    frameStyleKey: "none",
  },
  {
    key: "magazine",
    label: "Studio Light",
    description: "Bright studio light texture for modern portrait edits.",
    backgroundVideoPath: "/background-themes/theme-02.mp4",
    transitionKey: "fade",
    themeKey: "mono",
  ...
  },
  {
    key: "spotlight",
    label: "Warm Grain",
    description: "Warm film-grain style for emotional memory edits.",
    backgroundVideoPath: "/background-themes/theme-03.mp4",
  ...
  },
  {
    key: "cinematic",
    label: "Neo Grid",
    description: "Structured geometric motion background for dynamic cuts.",
    backgroundVideoPath: "/background-themes/theme-04.mp4",
  ...
  },
  {
    key: "ocean-drift",
    label: "Ocean Drift",
    description: "Cool ocean flow background for calm pacing.",
    backgroundVideoPath: "/background-themes/theme-05.mp4",
    transitionKey: "cut",
    themeKey: "editorial",
    frameStyleKey: "none",
  },
  {
    key: "night-pulse",
    label: "Night Pulse",
    description: "Dark ambient pulse background for stronger contrast.",
    backgroundVideoPath: "/background-themes/theme-06.mp4",
    transitionKey: "fade",
    themeKey: "mono",
    frameStyleKey: "single",
  },
